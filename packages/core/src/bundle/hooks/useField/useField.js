 ...
 * @param {boolean} [params.initialTouched] Initial touched state
 * @param {boolean} [params.autoFocus] Auto focus
 * @param {boolean} [params.validateOnChange] Validate on change
 * @param {boolean} [params.validateOnBlur] Validate on blur
 * @param {boolean} [params.validateOnMount] Validate on mount
