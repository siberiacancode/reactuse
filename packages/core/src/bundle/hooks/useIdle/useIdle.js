 ...
 * @category Sensors
 *
 * @param {number} [milliseconds] The idle time in milliseconds
 * @param {boolean} [options.initialState] The options for the hook
 * @param {Array<keyof WindowEventMap>} [options.events]
