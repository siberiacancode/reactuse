 ...
 *
 * @overload
 * @param {number} [initialTime] The initial time of the timer
 * @param {boolean} [options.enabled] The enabled state of the timer
 ...
 *
 * @overload
 * @param {number} [options.initialTime] -The initial time of the timer
 * @param {boolean} [options.enabled] The enabled state of the timer
 * @returns {UseStopwatchReturn} An object containing the current time and functions to interact with the timer
 *
 * @example
