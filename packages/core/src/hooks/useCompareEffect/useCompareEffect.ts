...
/** The function that compares a dependency with its previous value */
export type CompareFunction = (current: any, previous: any) => boolean;
...
export const useCompareEffect = (
  ...
  deps?: DependencyList,
  compare: CompareFunction = deepEqual
) => {
