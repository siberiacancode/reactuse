...
export const LandingHero = ({ hooksCount, release }: LandingHeroProps) => (
  <section className='relative mb-40 flex min-h-[45vh] items-center overflow-hidden pt-45'>
    <LandingBackdrop />
    ...
    <div className='relative container w-full'>
      <div className='mx-auto flex max-w-4xl flex-col items-center text-center'>
        ...
        <h1 className='text-foreground font-serif text-5xl leading-[1.05] font-normal tracking-tight md:text-7xl lg:text-8xl'>
          <span className='italic'>Every</span> hook your app will{' '}
          <span className='relative inline-flex align-middle'>
            <ReactIcon className='atom-spin text-foreground inline-block size-11 md:size-16 lg:size-20' />
          </span>{' '}
          ever need
        </h1>
        ...
        <div className='mt-8 flex flex-col items-center gap-3 sm:flex-row'>
          <Button
            className='group h-11 rounded-full px-7 text-sm'
            nativeButton={false}
          ...
          <Button
            ...
            nativeButton={false}
            render={<Link href={LINKS.GITHUB} prefetch={false} rel='noreferrer' target='_blank' />}
            variant='outline'
          >
