...
export const DocsLayout = async ({ children }: { children: React.ReactNode }) => {
  const functionsGroups = await getFunctionsSidebarGroups();
  ...
  return (
    <>
      ...
      <div className='container-wrapper flex flex-1 flex-col px-2'>
        ...
        >
          <DocsSidebar functionsGroups={functionsGroups} tree={source.pageTree} />
