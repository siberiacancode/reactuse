...
export const FunctionToc = ({
  ...
  return (
    <div className='flex flex-col gap-2 p-4 pt-0 text-sm sticky top-0'>
   ...
   <ul>
      ...
      <li >
        <a className='text-muted-foreground hover:text-foreground data-[active=true]:text-foreground text-[0.8rem] no-underline transition-colors data-[active=true]:font-medium data-[depth=3]:pl-4 data-[depth=4]:pl-6'
