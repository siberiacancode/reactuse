...
This will create a configuration file [`reactuse.json`](../reactuse-json.md) in your project. Ensure your `tsconfig.json` has path aliases (React Router often uses `~/*`). If you use `@/*`, add:
