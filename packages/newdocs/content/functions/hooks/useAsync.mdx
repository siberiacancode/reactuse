...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useAsync } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useAsync" __npm__="npx useverse@latest add useAsync" __pnpm__="pnpm dlx useverse@latest add useAsync" __yarn__="yarn useverse@latest add useAsync" />
  </TabsContent>
