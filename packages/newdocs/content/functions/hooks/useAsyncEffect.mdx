...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useAsyncEffect } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useAsyncEffect" __npm__="npx useverse@latest add useAsyncEffect" __pnpm__="pnpm dlx useverse@latest add useAsyncEffect" __yarn__="yarn useverse@latest add useAsyncEffect" />
  </TabsContent>
