...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useAudio } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useAudio" __npm__="npx useverse@latest add useAudio" __pnpm__="pnpm dlx useverse@latest add useAudio" __yarn__="yarn useverse@latest add useAudio" />
  </TabsContent>
