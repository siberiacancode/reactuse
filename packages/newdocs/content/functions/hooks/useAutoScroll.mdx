...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useAutoScroll } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useAutoScroll" __npm__="npx useverse@latest add useAutoScroll" __pnpm__="pnpm dlx useverse@latest add useAutoScroll" __yarn__="yarn useverse@latest add useAutoScroll" />
  </TabsContent>
