...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useBatchedCallback } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useBatchedCallback" __npm__="npx useverse@latest add useBatchedCallback" __pnpm__="pnpm dlx useverse@latest add useBatchedCallback" __yarn__="yarn useverse@latest add useBatchedCallback" />
  </TabsContent>
