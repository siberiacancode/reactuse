...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useBattery } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useBattery" __npm__="npx useverse@latest add useBattery" __pnpm__="pnpm dlx useverse@latest add useBattery" __yarn__="yarn useverse@latest add useBattery" />
  </TabsContent>
