...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useBluetooth } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useBluetooth" __npm__="npx useverse@latest add useBluetooth" __pnpm__="pnpm dlx useverse@latest add useBluetooth" __yarn__="yarn useverse@latest add useBluetooth" />
  </TabsContent>
