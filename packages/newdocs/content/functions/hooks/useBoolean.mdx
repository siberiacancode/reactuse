...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useBoolean } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useBoolean" __npm__="npx useverse@latest add useBoolean" __pnpm__="pnpm dlx useverse@latest add useBoolean" __yarn__="yarn useverse@latest add useBoolean" />
  </TabsContent>
