...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useBroadcastChannel } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useBroadcastChannel" __npm__="npx useverse@latest add useBroadcastChannel" __pnpm__="pnpm dlx useverse@latest add useBroadcastChannel" __yarn__="yarn useverse@latest add useBroadcastChannel" />
  </TabsContent>
