...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useBrowserLanguage } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useBrowserLanguage" __npm__="npx useverse@latest add useBrowserLanguage" __pnpm__="pnpm dlx useverse@latest add useBrowserLanguage" __yarn__="yarn useverse@latest add useBrowserLanguage" />
  </TabsContent>
