...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useClickOutside } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useClickOutside" __npm__="npx useverse@latest add useClickOutside" __pnpm__="pnpm dlx useverse@latest add useClickOutside" __yarn__="yarn useverse@latest add useClickOutside" />
  </TabsContent>
