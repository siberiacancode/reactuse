...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useClipboard } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useClipboard" __npm__="npx useverse@latest add useClipboard" __pnpm__="pnpm dlx useverse@latest add useClipboard" __yarn__="yarn useverse@latest add useClipboard" />
  </TabsContent>
