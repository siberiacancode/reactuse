...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useConst } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useConst" __npm__="npx useverse@latest add useConst" __pnpm__="pnpm dlx useverse@latest add useConst" __yarn__="yarn useverse@latest add useConst" />
  </TabsContent>
