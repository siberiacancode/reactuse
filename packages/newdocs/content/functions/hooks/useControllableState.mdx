...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useControllableState } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useControllableState" __npm__="npx useverse@latest add useControllableState" __pnpm__="pnpm dlx useverse@latest add useControllableState" __yarn__="yarn useverse@latest add useControllableState" />
  </TabsContent>
