...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useCookie } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useCookie" __npm__="npx useverse@latest add useCookie" __pnpm__="pnpm dlx useverse@latest add useCookie" __yarn__="yarn useverse@latest add useCookie" />
  </TabsContent>
