...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useCookies } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useCookies" __npm__="npx useverse@latest add useCookies" __pnpm__="pnpm dlx useverse@latest add useCookies" __yarn__="yarn useverse@latest add useCookies" />
  </TabsContent>
