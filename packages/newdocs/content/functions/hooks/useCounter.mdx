...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useCounter } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useCounter" __npm__="npx useverse@latest add useCounter" __pnpm__="pnpm dlx useverse@latest add useCounter" __yarn__="yarn useverse@latest add useCounter" />
  </TabsContent>
