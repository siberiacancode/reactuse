...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useCssVar } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useCssVar" __npm__="npx useverse@latest add useCssVar" __pnpm__="pnpm dlx useverse@latest add useCssVar" __yarn__="yarn useverse@latest add useCssVar" />
  </TabsContent>
