...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDebounceCallback } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDebounceCallback" __npm__="npx useverse@latest add useDebounceCallback" __pnpm__="pnpm dlx useverse@latest add useDebounceCallback" __yarn__="yarn useverse@latest add useDebounceCallback" />
  </TabsContent>
