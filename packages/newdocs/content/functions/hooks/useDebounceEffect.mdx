...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDebounceEffect } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDebounceEffect" __npm__="npx useverse@latest add useDebounceEffect" __pnpm__="pnpm dlx useverse@latest add useDebounceEffect" __yarn__="yarn useverse@latest add useDebounceEffect" />
  </TabsContent>
