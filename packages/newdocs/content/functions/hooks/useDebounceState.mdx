...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDebounceState } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDebounceState" __npm__="npx useverse@latest add useDebounceState" __pnpm__="pnpm dlx useverse@latest add useDebounceState" __yarn__="yarn useverse@latest add useDebounceState" />
  </TabsContent>
