...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDebounceValue } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDebounceValue" __npm__="npx useverse@latest add useDebounceValue" __pnpm__="pnpm dlx useverse@latest add useDebounceValue" __yarn__="yarn useverse@latest add useDebounceValue" />
  </TabsContent>
