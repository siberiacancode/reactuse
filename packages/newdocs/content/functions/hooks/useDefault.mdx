...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDefault } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDefault" __npm__="npx useverse@latest add useDefault" __pnpm__="pnpm dlx useverse@latest add useDefault" __yarn__="yarn useverse@latest add useDefault" />
  </TabsContent>
