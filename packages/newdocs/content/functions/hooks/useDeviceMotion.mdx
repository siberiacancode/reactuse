...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDeviceMotion } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDeviceMotion" __npm__="npx useverse@latest add useDeviceMotion" __pnpm__="pnpm dlx useverse@latest add useDeviceMotion" __yarn__="yarn useverse@latest add useDeviceMotion" />
  </TabsContent>
