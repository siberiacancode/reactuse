...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDeviceOrientation } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDeviceOrientation" __npm__="npx useverse@latest add useDeviceOrientation" __pnpm__="pnpm dlx useverse@latest add useDeviceOrientation" __yarn__="yarn useverse@latest add useDeviceOrientation" />
  </TabsContent>
