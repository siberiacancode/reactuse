...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDevicePixelRatio } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDevicePixelRatio" __npm__="npx useverse@latest add useDevicePixelRatio" __pnpm__="pnpm dlx useverse@latest add useDevicePixelRatio" __yarn__="yarn useverse@latest add useDevicePixelRatio" />
  </TabsContent>
