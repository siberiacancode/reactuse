...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDidUpdate } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDidUpdate" __npm__="npx useverse@latest add useDidUpdate" __pnpm__="pnpm dlx useverse@latest add useDidUpdate" __yarn__="yarn useverse@latest add useDidUpdate" />
  </TabsContent>
