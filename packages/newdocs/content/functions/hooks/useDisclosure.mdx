...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDisclosure } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDisclosure" __npm__="npx useverse@latest add useDisclosure" __pnpm__="pnpm dlx useverse@latest add useDisclosure" __yarn__="yarn useverse@latest add useDisclosure" />
  </TabsContent>
