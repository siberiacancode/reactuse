...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDisplayMedia } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDisplayMedia" __npm__="npx useverse@latest add useDisplayMedia" __pnpm__="pnpm dlx useverse@latest add useDisplayMedia" __yarn__="yarn useverse@latest add useDisplayMedia" />
  </TabsContent>
