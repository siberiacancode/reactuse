...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDocumentEvent } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDocumentEvent" __npm__="npx useverse@latest add useDocumentEvent" __pnpm__="pnpm dlx useverse@latest add useDocumentEvent" __yarn__="yarn useverse@latest add useDocumentEvent" />
  </TabsContent>
