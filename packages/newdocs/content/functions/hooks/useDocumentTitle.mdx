...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDocumentTitle } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDocumentTitle" __npm__="npx useverse@latest add useDocumentTitle" __pnpm__="pnpm dlx useverse@latest add useDocumentTitle" __yarn__="yarn useverse@latest add useDocumentTitle" />
  </TabsContent>
