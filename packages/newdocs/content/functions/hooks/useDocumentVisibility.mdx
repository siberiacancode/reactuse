...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDocumentVisibility } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDocumentVisibility" __npm__="npx useverse@latest add useDocumentVisibility" __pnpm__="pnpm dlx useverse@latest add useDocumentVisibility" __yarn__="yarn useverse@latest add useDocumentVisibility" />
  </TabsContent>
