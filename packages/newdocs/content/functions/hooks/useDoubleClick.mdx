...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDoubleClick } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDoubleClick" __npm__="npx useverse@latest add useDoubleClick" __pnpm__="pnpm dlx useverse@latest add useDoubleClick" __yarn__="yarn useverse@latest add useDoubleClick" />
  </TabsContent>
