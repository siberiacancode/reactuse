...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useDropZone } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useDropZone" __npm__="npx useverse@latest add useDropZone" __pnpm__="pnpm dlx useverse@latest add useDropZone" __yarn__="yarn useverse@latest add useDropZone" />
  </TabsContent>
