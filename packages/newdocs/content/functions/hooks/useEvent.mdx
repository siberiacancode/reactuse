...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useEvent } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useEvent" __npm__="npx useverse@latest add useEvent" __pnpm__="pnpm dlx useverse@latest add useEvent" __yarn__="yarn useverse@latest add useEvent" />
  </TabsContent>
