...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useEventListener } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useEventListener" __npm__="npx useverse@latest add useEventListener" __pnpm__="pnpm dlx useverse@latest add useEventListener" __yarn__="yarn useverse@latest add useEventListener" />
  </TabsContent>
