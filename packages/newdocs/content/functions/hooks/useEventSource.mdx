...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useEventSource } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useEventSource" __npm__="npx useverse@latest add useEventSource" __pnpm__="pnpm dlx useverse@latest add useEventSource" __yarn__="yarn useverse@latest add useEventSource" />
  </TabsContent>
