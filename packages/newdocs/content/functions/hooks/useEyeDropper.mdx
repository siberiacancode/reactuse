...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useEyeDropper } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useEyeDropper" __npm__="npx useverse@latest add useEyeDropper" __pnpm__="pnpm dlx useverse@latest add useEyeDropper" __yarn__="yarn useverse@latest add useEyeDropper" />
  </TabsContent>
