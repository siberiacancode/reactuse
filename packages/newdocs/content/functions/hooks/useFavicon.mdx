...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFavicon } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFavicon" __npm__="npx useverse@latest add useFavicon" __pnpm__="pnpm dlx useverse@latest add useFavicon" __yarn__="yarn useverse@latest add useFavicon" />
  </TabsContent>
