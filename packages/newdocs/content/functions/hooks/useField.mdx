...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useField } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useField" __npm__="npx useverse@latest add useField" __pnpm__="pnpm dlx useverse@latest add useField" __yarn__="yarn useverse@latest add useField" />
  </TabsContent>
