...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFileDialog } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFileDialog" __npm__="npx useverse@latest add useFileDialog" __pnpm__="pnpm dlx useverse@latest add useFileDialog" __yarn__="yarn useverse@latest add useFileDialog" />
  </TabsContent>
