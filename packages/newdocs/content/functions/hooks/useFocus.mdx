...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFocus } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFocus" __npm__="npx useverse@latest add useFocus" __pnpm__="pnpm dlx useverse@latest add useFocus" __yarn__="yarn useverse@latest add useFocus" />
  </TabsContent>
