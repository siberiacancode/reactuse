...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFocusTrap } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFocusTrap" __npm__="npx useverse@latest add useFocusTrap" __pnpm__="pnpm dlx useverse@latest add useFocusTrap" __yarn__="yarn useverse@latest add useFocusTrap" />
  </TabsContent>
