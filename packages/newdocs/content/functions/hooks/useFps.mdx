...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFps } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFps" __npm__="npx useverse@latest add useFps" __pnpm__="pnpm dlx useverse@latest add useFps" __yarn__="yarn useverse@latest add useFps" />
  </TabsContent>
