...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFul } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFul" __npm__="npx useverse@latest add useFul" __pnpm__="pnpm dlx useverse@latest add useFul" __yarn__="yarn useverse@latest add useFul" />
  </TabsContent>
