...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useFullscreen } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useFullscreen" __npm__="npx useverse@latest add useFullscreen" __pnpm__="pnpm dlx useverse@latest add useFullscreen" __yarn__="yarn useverse@latest add useFullscreen" />
  </TabsContent>
