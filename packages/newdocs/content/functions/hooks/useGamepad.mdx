...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useGamepad } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useGamepad" __npm__="npx useverse@latest add useGamepad" __pnpm__="pnpm dlx useverse@latest add useGamepad" __yarn__="yarn useverse@latest add useGamepad" />
  </TabsContent>
