...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useGeolocation } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useGeolocation" __npm__="npx useverse@latest add useGeolocation" __pnpm__="pnpm dlx useverse@latest add useGeolocation" __yarn__="yarn useverse@latest add useGeolocation" />
  </TabsContent>
