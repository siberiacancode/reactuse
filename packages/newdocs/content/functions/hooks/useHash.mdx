...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useHash } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useHash" __npm__="npx useverse@latest add useHash" __pnpm__="pnpm dlx useverse@latest add useHash" __yarn__="yarn useverse@latest add useHash" />
  </TabsContent>
