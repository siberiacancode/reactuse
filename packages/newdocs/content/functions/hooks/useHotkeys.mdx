...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useHotkeys } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useHotkeys" __npm__="npx useverse@latest add useHotkeys" __pnpm__="pnpm dlx useverse@latest add useHotkeys" __yarn__="yarn useverse@latest add useHotkeys" />
  </TabsContent>
