...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useHover } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useHover" __npm__="npx useverse@latest add useHover" __pnpm__="pnpm dlx useverse@latest add useHover" __yarn__="yarn useverse@latest add useHover" />
  </TabsContent>
