...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useIdle } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useIdle" __npm__="npx useverse@latest add useIdle" __pnpm__="pnpm dlx useverse@latest add useIdle" __yarn__="yarn useverse@latest add useIdle" />
  </TabsContent>
