...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useIntersectionObserver } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useIntersectionObserver" __npm__="npx useverse@latest add useIntersectionObserver" __pnpm__="pnpm dlx useverse@latest add useIntersectionObserver" __yarn__="yarn useverse@latest add useIntersectionObserver" />
  </TabsContent>
