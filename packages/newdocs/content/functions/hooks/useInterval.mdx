...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useInterval } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useInterval" __npm__="npx useverse@latest add useInterval" __pnpm__="pnpm dlx useverse@latest add useInterval" __yarn__="yarn useverse@latest add useInterval" />
  </TabsContent>
