...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useIsFirstRender } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useIsFirstRender" __npm__="npx useverse@latest add useIsFirstRender" __pnpm__="pnpm dlx useverse@latest add useIsFirstRender" __yarn__="yarn useverse@latest add useIsFirstRender" />
  </TabsContent>
