...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useKeyPress } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useKeyPress" __npm__="npx useverse@latest add useKeyPress" __pnpm__="pnpm dlx useverse@latest add useKeyPress" __yarn__="yarn useverse@latest add useKeyPress" />
  </TabsContent>
