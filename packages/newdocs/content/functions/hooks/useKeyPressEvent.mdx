...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useKeyPressEvent } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useKeyPressEvent" __npm__="npx useverse@latest add useKeyPressEvent" __pnpm__="pnpm dlx useverse@latest add useKeyPressEvent" __yarn__="yarn useverse@latest add useKeyPressEvent" />
  </TabsContent>
