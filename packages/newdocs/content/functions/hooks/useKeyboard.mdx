...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useKeyboard } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useKeyboard" __npm__="npx useverse@latest add useKeyboard" __pnpm__="pnpm dlx useverse@latest add useKeyboard" __yarn__="yarn useverse@latest add useKeyboard" />
  </TabsContent>
