...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useKeysPressed } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useKeysPressed" __npm__="npx useverse@latest add useKeysPressed" __pnpm__="pnpm dlx useverse@latest add useKeysPressed" __yarn__="yarn useverse@latest add useKeysPressed" />
  </TabsContent>
