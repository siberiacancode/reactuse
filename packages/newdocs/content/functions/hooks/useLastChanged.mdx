...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLastChanged } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLastChanged" __npm__="npx useverse@latest add useLastChanged" __pnpm__="pnpm dlx useverse@latest add useLastChanged" __yarn__="yarn useverse@latest add useLastChanged" />
  </TabsContent>
