...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLatest } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLatest" __npm__="npx useverse@latest add useLatest" __pnpm__="pnpm dlx useverse@latest add useLatest" __yarn__="yarn useverse@latest add useLatest" />
  </TabsContent>
