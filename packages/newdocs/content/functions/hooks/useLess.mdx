...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLess } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLess" __npm__="npx useverse@latest add useLess" __pnpm__="pnpm dlx useverse@latest add useLess" __yarn__="yarn useverse@latest add useLess" />
  </TabsContent>
