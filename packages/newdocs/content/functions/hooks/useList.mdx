...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useList } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useList" __npm__="npx useverse@latest add useList" __pnpm__="pnpm dlx useverse@latest add useList" __yarn__="yarn useverse@latest add useList" />
  </TabsContent>
