...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLocalStorage } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLocalStorage" __npm__="npx useverse@latest add useLocalStorage" __pnpm__="pnpm dlx useverse@latest add useLocalStorage" __yarn__="yarn useverse@latest add useLocalStorage" />
  </TabsContent>
