...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLockCallback } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLockCallback" __npm__="npx useverse@latest add useLockCallback" __pnpm__="pnpm dlx useverse@latest add useLockCallback" __yarn__="yarn useverse@latest add useLockCallback" />
  </TabsContent>
