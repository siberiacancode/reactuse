...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLockScroll } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLockScroll" __npm__="npx useverse@latest add useLockScroll" __pnpm__="pnpm dlx useverse@latest add useLockScroll" __yarn__="yarn useverse@latest add useLockScroll" />
  </TabsContent>
