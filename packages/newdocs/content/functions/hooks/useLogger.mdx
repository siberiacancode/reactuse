...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLogger } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLogger" __npm__="npx useverse@latest add useLogger" __pnpm__="pnpm dlx useverse@latest add useLogger" __yarn__="yarn useverse@latest add useLogger" />
  </TabsContent>
