...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useLongPress } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useLongPress" __npm__="npx useverse@latest add useLongPress" __pnpm__="pnpm dlx useverse@latest add useLongPress" __yarn__="yarn useverse@latest add useLongPress" />
  </TabsContent>
