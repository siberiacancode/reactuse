...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMap } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMap" __npm__="npx useverse@latest add useMap" __pnpm__="pnpm dlx useverse@latest add useMap" __yarn__="yarn useverse@latest add useMap" />
  </TabsContent>
