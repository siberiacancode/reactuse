...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMeasure } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMeasure" __npm__="npx useverse@latest add useMeasure" __pnpm__="pnpm dlx useverse@latest add useMeasure" __yarn__="yarn useverse@latest add useMeasure" />
  </TabsContent>
