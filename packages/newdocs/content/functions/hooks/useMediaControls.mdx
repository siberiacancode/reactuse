...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMediaControls } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMediaControls" __npm__="npx useverse@latest add useMediaControls" __pnpm__="pnpm dlx useverse@latest add useMediaControls" __yarn__="yarn useverse@latest add useMediaControls" />
  </TabsContent>
