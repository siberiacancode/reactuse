...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMediaQuery } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMediaQuery" __npm__="npx useverse@latest add useMediaQuery" __pnpm__="pnpm dlx useverse@latest add useMediaQuery" __yarn__="yarn useverse@latest add useMediaQuery" />
  </TabsContent>
