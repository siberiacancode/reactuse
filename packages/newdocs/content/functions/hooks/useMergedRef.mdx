...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMergedRef } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMergedRef" __npm__="npx useverse@latest add useMergedRef" __pnpm__="pnpm dlx useverse@latest add useMergedRef" __yarn__="yarn useverse@latest add useMergedRef" />
  </TabsContent>
