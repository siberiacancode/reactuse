...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMount } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMount" __npm__="npx useverse@latest add useMount" __pnpm__="pnpm dlx useverse@latest add useMount" __yarn__="yarn useverse@latest add useMount" />
  </TabsContent>
