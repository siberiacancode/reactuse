...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMouse } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMouse" __npm__="npx useverse@latest add useMouse" __pnpm__="pnpm dlx useverse@latest add useMouse" __yarn__="yarn useverse@latest add useMouse" />
  </TabsContent>
