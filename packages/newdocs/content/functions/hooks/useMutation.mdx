...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMutation } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMutation" __npm__="npx useverse@latest add useMutation" __pnpm__="pnpm dlx useverse@latest add useMutation" __yarn__="yarn useverse@latest add useMutation" />
  </TabsContent>
