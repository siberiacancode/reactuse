...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useMutationObserver } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useMutationObserver" __npm__="npx useverse@latest add useMutationObserver" __pnpm__="pnpm dlx useverse@latest add useMutationObserver" __yarn__="yarn useverse@latest add useMutationObserver" />
  </TabsContent>
