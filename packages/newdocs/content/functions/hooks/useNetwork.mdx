...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useNetwork } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useNetwork" __npm__="npx useverse@latest add useNetwork" __pnpm__="pnpm dlx useverse@latest add useNetwork" __yarn__="yarn useverse@latest add useNetwork" />
  </TabsContent>
