...
<Tabs defaultValue="library">
  ...
  <TabsContent className="space-y-3" value="library">
    <Code code={`import { useObject } from '@siberiacancode/reactuse';`} />
  </TabsContent>

  <TabsContent className="space-y-3" value="cli">
    <CodeBlockCommand __bun__="bunx --bun useverse@latest add useObject" __npm__="npx useverse@latest add useObject" __pnpm__="pnpm dlx useverse@latest add useObject" __yarn__="yarn useverse@latest add useObject" />
  </TabsContent>
