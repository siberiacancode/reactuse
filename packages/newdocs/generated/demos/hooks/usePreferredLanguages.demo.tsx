...
const TRANSLATIONS = {
  ...
  ru: { greeting: 'Привет!', subtitle: 'Добро пожаловать в reactuse' },
  ...
  ja: { greeting: 'こんにちは！', subtitle: 'reactuseへようこそ' },
  zh: { greeting: '你好！', subtitle: '欢迎使用 reactuse' },
  pt: { greeting: 'Olá!', subtitle: 'Bem-vindo ao reactuse' }
};
