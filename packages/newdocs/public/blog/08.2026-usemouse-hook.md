---
title: 'React useMouse: cursor tracking without the re-render tax'
description: Every coordinate in one call, a callback-first API that skips re-renders, and opt-in watch() for reactive state.
date: 2026-08-10
---
