...
Hook that cycles through a list of items
...
| --- | --- | --- | --- |
| list | `[Value, ...Value[]]` | - | The non-empty list of items to cycle through |
| initialIndex | `number` | 0 | The initial index in the list |

### Returns

`UseCycleListReturn<Value>` - An object containing the current item, current index, and functions to cycle through the list