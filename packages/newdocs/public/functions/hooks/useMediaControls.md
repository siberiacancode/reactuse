...
Hook that provides controls for HTML media elements (audio/video)
...
const Demo = () => {
  ...
  return (
    <section className='flex w-full max-w-xs flex-col gap-4 p-4 md:max-w-3xl md:flex-row md:items-start md:justify-center md:gap-6'>
      <audio ref={audio.ref} />

      <div className='flex min-w-0 flex-col gap-4 md:w-[320px] md:shrink-0'>
        <div
          className={cn(
      ...
      <div className='flex min-w-0 flex-col gap-0.5 md:w-60 md:self-start'>
...
`UseMediaControlsReturn` - An object containing media controls and state
...
`UseMediaControlsReturn & { ref: StateRef<Target> }` - An object containing media controls, state and ref
