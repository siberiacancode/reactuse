...
isTest: true
isDemo: true
lastModifiedTime: 1781882408000
---
...
| --- | --- | --- | --- |
| callback | `(value: UseTextSelectionReturn, event: Event) => void` | - | The callback to invoke on selection updates |

### Returns

`UseTextSelectionReturn` - An object containing the current text selection