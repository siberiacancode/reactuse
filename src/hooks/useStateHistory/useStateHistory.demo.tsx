...
const Demo = () => {
    ...
    return (
        <div>
            ...
            <div className="mb-1">
                <button type="button" onClick={() => stateHistory.back()}>Back</button>
                <button type="button" onClick={() => stateHistory.forward()}>Next</button>
                <button type="button" onClick={stateHistory.reset}>Reset</button>
                <button type="button" onClick={stateHistory.undo}>Undo</button>
